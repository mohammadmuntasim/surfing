						...
						<div class="row">
							<div class="col-md-6">
								<div class="well-block">
									<form action="{{url('/appointments')}}<?php if(!empty($_GET['ref_app'])): echo '?ref_app='.$_GET['ref_app']; endif; ?>"  role="form" id="myBooking" data-toggle="validator"  class="profile-edit-form" method="post">
										{{ csrf_field() }}
										<!-- Form start -->
										...
										<div class="row">
												...
												<div class="form-group">
													...
													<select class="form-control selectpicker insurance_provider" id="insurance_provider" data-live-search="true"  name="insurance_provider" required>
														...
														<option value="No Insurance">No Insurance</option>
														 @foreach($data['userinsurance'] as $doctordatas)
											...
											<div class="col-md-6">
												<div class="form-group" >
													...
													<select class="form-control selectpicker insurance_palns" id="insurance_plan_id" name="insurance_plan_id" data-live-search="true" required >
														...
														<option value="No Insurance Plan">No Insurance Plan</option>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													@endforeach
													@endif
													<input id="contact_number" name="contact_number"  data-toggle="tooltip" title="Contact Number" type="text" placeholder="(xxx)xxx-xxxx" class="form-control input-md" @if(!empty($checkgenderm)) value="{{$checkgenderm}}" @endif  required  min="10" max="10"  minlength="13" maxlength="14"  onkeypress="return isNumber(event)">
												</div>
											</div>
																						<!-- Select Basic -->
											<div class="col-md-12 gender-selection">
												<div class="form-group">
													...
													@endforeach
													@endif
													<div class=" col-md-10 gender-select" >

													<input class="patient_gender" id="patient_gender" name="patient_gender" type="radio" title="Female" class="form-control input-md" value="female" @if($checkgender=='female') checked @endif required><label for="patient_gender">Female</label>
													<input class="patient_gender" id="patient_gender" name="patient_gender" type="radio" title="Male" class="form-control input-md" value="male" @if($checkgender=='male') checked @endif required><label for="patient_gender">Male</label>
												</div>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<!-- <label class="control-label" for="booking_time">Available Times</label> -->
													<!-- <input id="booking_time"   data-toggle="modal" data-target="#myAppoTime" name="booking_time" type="hidden" title="Book Time" placeholder="Choose Time" class="timepicker form-control input-md" value=" " required> -->
<div id="myAppoTime"  >
  <div class="modal-dialogs">
    ...
    <div class="modal-contents">
      <div class="modal-header"> 
        ...
        <h4 class="modal-title"><div class="pull-left">Available Times</div>


         <input id="booking_time"   name="booking_time" data-error="Oops!.. please select available time." required type="text" title="Book Time" placeholder="" class="form-control input-sm" value=" " required disable></h4>
