          ...
          <tr>
            <td>
              ...
              <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
                                      ...
                                      <td align="center" valign="top" class="mob_center">
                                        <center style="width: 250px;display: inline-block;">
                                          <a href="{{url('/')}}" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;width: 100%;
                                            float: left;">
                                            <img src="{{url('/')}}/storage/{{Voyager::setting('email_logo')}}" width="auto" height="auto" alt="Surf Health" border="0" />  
                                        </center>
                                      </td>
                                    </tr>
                                  </table>
                ...
                <!--header END-->
                <!--content 1 START-->
                <tr><td align="center" bgcolor="#fbfcfd" style="    border-bottom: 3px solid #3d88ed;">
                <table width="90%" border="0" cellspacing="0" cellpadding="0">
