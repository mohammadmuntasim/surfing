...
<div style="height: 40px; line-height: 40px; font-size: 10px;">&nbsp;</div>
                            <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;box-sizing:border-box;font-size:14px;margin:0">                             
<a href="{{url('/password/reset')}}/{{$token}}" style="padding: 10px 20px 10px 20px;    background-color: #f99104;border-radius: 3px;    text-decoration: none;font-size: 18px; font-weight: 400;color:#fff;">Reset Password</a>
                            </div>
                            <!-- padding -->
                            <div style="height: 40px; line-height: 40px; font-size: 10px;">&nbsp;</div>
                          </td>
                        ...
                        <tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;box-sizing:border-box;font-size:14px;margin:0">
                                    ...
                                    <td  style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;box-sizing:border-box;font-size:14px;vertical-align:top;margin:0;padding:0 0 20px" valign="top"> If you did not request a password reset, no further action is required.</td>
                                </tr>
                        <tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;box-sizing:border-box;font-size:14px;margin:0">
